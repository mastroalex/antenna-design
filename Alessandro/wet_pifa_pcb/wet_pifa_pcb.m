...
%%
pk_pcb_array_azimuth_broadside=findpeaks(pcb_array_azimuth_broadside,'MinPeakDistance',6);
...
pk_SL_pcb_array_azimuth_broadside=sort_pcb_array_azimuth_broadside(3);

pk_pifa_array_azimuth_broadside=findpeaks(pifa_array_azimuth_broadside,'MinPeakDistance',6);
...
disp(" ")
pk_pcb_array_elevation_broadside=findpeaks(pcb_array_elevation_broadside,'MinPeakDistance',6);
...
pk_SL_pcb_array_elevation_broadside=sort_pcb_array_elevation_broadside(3);

pk_pifa_array_elevation_broadside=findpeaks(pifa_array_elevation_broadside,'MinPeakDistance',6);
...
pk_SL_pcb_array_azimuth_steering_45=sort_pcb_array_azimuth_steering_45(5);

pk_pifa_array_azimuth_steering_45=findpeaks(pifa_array_azimuth_steering_45,'MinPeakWidth',6);
...
pk_SL_pcb_array_elevation_steering_45=sort_pcb_array_elevation_steering_45(5);

pk_pifa_array_elevation_steering_45=findpeaks(pifa_array_elevation_steering_45,'MinPeakWidth',6);

...
%
%
%%%%%%%%%%%%%% SOSTITUISCI w e kfa con due valori aggiornati 
%
%
%
%
...
figure;
EHfields(kfa_ster,2.1e9,pfre_steering_45);
...
figure;
EHfields(kfa_ster,2.1e9,pfresnel_steering_45);
EH_center_45 = EHfields(kfa_ster,2.1e9,pfresnel_steering_45);

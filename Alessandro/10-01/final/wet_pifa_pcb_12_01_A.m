...
figure; 
polarpattern(pat_af_az);
figure
polarpattern(pat_af_el); 
figure;
plot(-180:180,pat_af_az); 
figure;
plot(-180:180,pat_af_el); 
...
pfraun_broadside=[X(:)';Y(:)';(fraun/2)*ones(1,prod(size(X)))];
pfar_broadside=[X(:)';Y(:)';(4*fraun)*ones(1,prod(size(X)))];
...
pfraunhofer_broadside = [Xsp(:)';Ysp(:)';(fraun/2)*ones(1,prod(size(Xsp)))];
pfarfield_broadside = [Xsp(:)';Ysp(:)';(4*fraun)*ones(1,prod(size(Xsp)))];
figure;
...
% pifa_array_gain_elevation_broadside=gain_broadside(2.1e9,[z   eros(1,181);-90:90]);
...
pfraun_steering_45=[X(:)';Y(:)';(fraun/2)*ones(1,prod(size(X)))];
pfar_steering_45=[X(:)';Y(:)';(4*fraun)*ones(1,prod(size(X)))];
figure;
...
pfraunhofer_steering_45 = [Xsp(:)';Ysp(:)';(fraun/2)*ones(1,prod(size(Xsp)))];
pfarfield_steering_45 = [Xsp(:)';Ysp(:)';4*fraun*ones(1,prod(size(Xsp)))];
figure;
...
Ec90f = EH_90_center_fraun(1, :);
Hc90f = EH_90_center_fraun(2, :);
Ec45f = EH_center_45_fraunhofer(1,:);
Hc45f = EH_center_45_fraunhofer(2,:);

Ec90l = EH_90_center_farf(1,:);
Hc90l = EH_90_center_farf(2,:);
Ec45l = EH_center_45_farfield(1,:);
Hc45l = EH_center_45_farfield(2,:);
...
nEc90f = [abs(Ec90f(1)) abs(Ec90f(2)) abs(Ec90f(3)) abs(Ec90f(4)) abs(Ec90f(5))];
nHc90f = [abs(Hc90f(1)) abs(Hc90f(2)) abs(Hc90f(3)) abs(Hc90f(4)) abs(Hc90f(5))];
nEc45f = [abs(Ec45f(1)) abs(Ec45f(2)) abs(Ec45f(3)) abs(Ec45f(4)) abs(Ec45f(5))];
nHc45f = [abs(Hc45f(1)) abs(Hc45f(2)) abs(Hc45f(3)) abs(Hc45f(4)) abs(Hc45f(5))];

nEc90l = [abs(Ec90l(1)) abs(Ec90l(2)) abs(Ec90l(3)) abs(Ec90l(4)) abs(Ec90l(5))];
nHc90l = [abs(Hc90l(1)) abs(Hc90l(2)) abs(Hc90l(3)) abs(Hc90l(4)) abs(Hc90l(5))];
nEc45l = [abs(Ec45l(1)) abs(Ec45l(2)) abs(Ec45l(3)) abs(Ec45l(4)) abs(Ec45l(5))];
nHc45l = [abs(Hc45l(1)) abs(Hc45l(2)) abs(Hc45l(3)) abs(Hc45l(4)) abs(Hc45l(5))];
%%

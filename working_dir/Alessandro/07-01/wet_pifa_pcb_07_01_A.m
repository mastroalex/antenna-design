...
figure;
polarpattern(pifa_array_gain_azimuth_broadside,'TitleTop','pifa_array_gain_azimuth_broadside');
pifa_array_gain_elevation_broadside_edit=[zeros(90,1)'*NaN, pifa_array_gain_elevation_broadside', zeros(90,1)'*NaN];
figure;
polarpattern(pifa_array_gain_elevation_broadside_edit,'TitleTop','pifa_array_gain_elevation_broadside');
figure;
polarpattern(pcb_array_gain_azimuth_broadside,'TitleTop','pcb_array_gain_azimuth_broadside');
figure;
polarpattern(pcb_array_gain_elevation_broadside,'TitleTop','pcb_array_gain_elevation_broadside');

figure;
polarpattern(pifa_array_gain_azimuth_broadside);
hold on
polarpattern(pcb_array_gain_azimuth_broadside,'TitleTop','pcb_vs_pifa_array_gain_azimuth_broadside');
hold off

figure;
polarpattern(pifa_array_gain_elevation_broadside_edit);
hold on
polarpattern(pcb_array_gain_elevation_broadside.*[zeros(90,1)'*NaN, ones(181,1)', zeros(90,1)'*NaN]','TitleTop','pcb_vs_pifa_array_gain_elevation_broadside');
hold off

figure;
polarpattern(pcb_array_gain_azimuth_broadside);
hold on
polarpattern(pcb_array_ideal_gain_azimuth_broadside,'TitleTop','pcb array azimuth gain real vs ideal');
hold off

figure;
polarpattern(pcb_array_gain_elevation_broadside);
hold on
polarpattern(pcb_array_ideal_gain_elevation_broadside,'TitleTop','pcb array elevation gain real vs ideal');
hold off
...
pcb_array_ideal_gain_azimuth_45=patternMultiply(kfa,2.1e9,-180:180,0,'Type','gain');
pcb_array_ideal_gain_elevation_45=patternMultiply(kfa,2.1e9,0,-180:180,'Type','gain');

figure;
polarpattern(pifa_array_gain_azimuth_45,'TitleTop','pifa_array_gain_azimuth_45');
pifa_array_gain_elevation_45_edit=[zeros(90,1)'*NaN, pifa_array_gain_elevation_45', zeros(90,1)'*NaN];
figure;
polarpattern(pifa_array_gain_elevation_45_edit,'TitleTop','pifa_array_gain_elevation_45');
figure;
polarpattern(pcb_array_gain_azimuth_45,'TitleTop','pcb_array_gain_azimuth_45');
figure;
polarpattern(pcb_array_gain_elevation_45,'TitleTop','pcb_array_gain_elevation_45');

figure;
polarpattern(pifa_array_gain_azimuth_45);
hold on
polarpattern(pcb_array_gain_azimuth_45,'TitleTop','pcb_vs_pifa_array_gain_azimuth_45');
hold off

figure;
polarpattern(pifa_array_gain_elevation_45_edit);
hold on
polarpattern(pcb_array_gain_elevation_45.*[zeros(90,1)'*NaN, ones(181,1)', zeros(90,1)'*NaN]','TitleTop','pcb_vs_pifa_array_gain_elevation_45');
hold off

figure;
polarpattern(pcb_array_gain_azimuth_45);
hold on
polarpattern(pcb_array_ideal_gain_azimuth_45,'TitleTop','pcb array azimuth 45 gain real vs ideal');
hold off

figure;
polarpattern(pcb_array_gain_elevation_45);
hold on
polarpattern(pcb_array_ideal_gain_elevation_45,'TitleTop','pcb array elevation 45 gain real vs ideal');
hold off
...
etaR_pifa=10.^((pifa_array_gain_azimuth_broadside-pifa_array_azimuth_broadside)/10);
disp(strcat('Efficiency of pifa array: '," ",string(etaR_pifa(1))));

etaR_pcb=10.^((pcb_array_gain_azimuth_broadside-pcb_array_azimuth_broadside)/10);
disp(strcat('Efficiency of pcb array: '," ",string(etaR_pcb(1))));
disp(" ")
etaR_pifa_steer=10.^((pifa_array_gain_azimuth_45-pifa_array_azimuth_steering_45)/10);
disp(strcat('Efficiency of pifa array steered: '," ",string(etaR_pifa_steer(1))));

etaR_pcb_steer=10.^((pcb_array_gain_elevation_45-pcb_array_elevation_steering_45)/10);
disp(strcat('Efficiency of pcb array steered: '," ",string(mean(etaR_pcb_steer))));

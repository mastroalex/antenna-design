...
\title{\fontfamily{qag}\selectfont\color{Turquoise}Design of an array of folded patches}
\author{Blasi Luca, Mastrofini Alessandro, Mucenica Stefan Leonard}
\date{}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
...
\fancypagestyle{plain}{
	...
	\lhead{\small Wireless Electromagnetic Technologies \\
...
\indent The design parameters for the array are: 
...
\end{figure}
\end{center}
\section*{Overall array performance evaluation}

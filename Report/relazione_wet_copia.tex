...
\fancypagestyle{plain}{
	...
	\rhead{\includegraphics[height=70pt]{logo.png} }
}
\usepackage{lastpage}
...
\indent The design parameters for the array are (\textbf{\cref{table:design_cheb_par}}): 
		% \FloatBarrier
			...
			\begin{tabular}{||m{5cm}|m{5cm}||}
				\hline 
				\rowcolor{lightgray}\multicolumn{2}{|c|}{\textbf{Array factor design parameters}} 
				\\
				\hline
				\cellcolor{mintbg}\textbf{Parameters} & \cellcolor{mintbg}\textbf{Value}\\
				\hline
				\hline
...
\subsection*{Max/min feed ratio}

Even if this is the design of a Non-Uniform Amplitude Array, the less the ratio $r_{\max/\min}\,=\,\frac{C_{\max}}{C_{\min}}$ is, the more efficient distribution of current is reached. In this particular design: 
\begin{equation}
...
\begin{figure}[h]
	\begin{center}
		...
		\begin{subfigure}{0.3\linewidth}
			...
			\caption{}
		\end{subfigure}
		\caption{\fontfamily{lmss}\selectfont (a) ($s_m,\Gamma_{dB}$) plot, (b) ($s_m,\Delta f$) plot, and (c) ($s_m,f$) plot} 
	\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

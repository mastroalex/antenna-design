...
\fancyfoot[R]{\tiny{\thepage\  of \pageref{LastPage}}}
...
\begin{table}
	\begin{center}
		{\fontfamily{ptm}\selectfont	\begin{tabular}{|m{2cm}|m{2cm}|}
				\hline
				\cellcolor{deepsaffron}\textbf{Parameter} & \cellcolor{deepsaffron}\textbf{Value}\\
				\hline
...
\begin{figure*}[bt!]
	...
	\fontsize{4}{4}\selectfont{\input{pcb_array_azimuth_45_gain_real_vs_ideal.pdf_tex}}
		\caption{}
	\end{subfigure}\hfill
	\caption{2D gain patterns for the array (ideal \textcolor{myOrange}{$\blacksquare$} and real \textcolor{myBlue}{$\blacksquare$} ) in both the broadside case ((a) azimuth cut and (b) elevation cut) and $45^\circ$ off the boresight direction ((c) azimuth cut and (d) elevation cut).}
...
\begin{figure*}[b!]
	...
	\begin{tikzpicture}
		...
		{\textmd{INPUT VARIABLES}
			...
			\fontsize{6}{4}\selectfont 	no. of elements, |main to side lobe ratio, operating frequency};
